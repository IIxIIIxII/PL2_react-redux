...
const Register = ()=>{
    ...
    const validateForm = () => {
        ...
        if (form.password !== form.confirmPassword) newErrors.confirmPassword = "Секреты пони не совпадают!";
        if (form.password.length < 6) newErrors.password = "Секрет пони должен быть не менее 6 символов!";
        return newErrors;
    };
